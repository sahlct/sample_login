...
export default function Content() {
    return (
        <div className="md:ms-[120px] xl:ms-32 md:pt-20 pt-14 min-h-screen font-[Poppins]">
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-5 px-5 pt-10 min-h-64 lgx:h-86 lxx:h-96 h-fit">
                ...
                <div className="rounded-2xl z-30 flex flex-col justify-between bg-[#FFFFFF54] shadow-2xl p-5 pb-0 h-full">
                    <div className="flex justify-between items-center mb-5 md:mb-0">
                        <p className="text-lg lgx:text-xl font-semibold">Documents Expiring</p>
                        {button}
                    </div>
                ...
                <div className="lg:col-span-2 z-30 rounded-2xl bg-[#FFFFFF66] shadow-2xl p-5 flex flex-col gap-5 overflow-auto">
                    <div className="flex justify-between items-center">
                        <p className="text-lg lgx:text-xl font-semibold text-start">This Month Expires Documents</p>
                        {button}
                    </div>
                    <div>
                        <div className="flex justify-around gap-2 md:text-[11px] text-[10px] 2xl:text-[15px]">
                            <p>Entity</p>
                            <p>Email</p>
                    ...
                    <div className="flex justify-center items-end h-full z-30">
                        <img src="/assets/box.png" alt="box" className="h-28 xl:h-32 2xl:h-40" />
                    </div>
                </div>

            </div>

            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 px-5 lxx:h-72 min-h-56 pb-10 md:pb-0 pt-5">

                {/* grid-3  */}
                <div className="shadow-2xl h-full z-30 bg-[#FFFFFF54] rounded-2xl p-5 flex flex-col gap-4">
                    <div className="flex justify-between items-center">
                        <p className="text-lg lgx:text-xl font-semibold">Documents Expiry</p>
                        {button}
                    </div>
                    <div>
                        <div className="flex justify-around md:text-[11px] text-[10px] 2xl:text-[15px]">
                            <p>Document Type</p>
                            <p>Document Name</p>
                            <p>Status</p>
                            <p>Details</p>
                    ...
                    {blueCardsData.map((card, index) => (
                        <div key={index} className="bg-[#4b66e3] cursor-pointer rounded-2xl flex flex-col justify-between p-2 relative">
                            <div className="flex flex-wrap justify-between items-center">
                                ...
                                <p className="md:text-[11px] text-[8px] 2xl:text-[15px] font-semibold text-white">{card.title}</p>
                            </div>
